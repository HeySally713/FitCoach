...
const exercises: Record<string, Exercise[]> = {
  ...
  home: [
    ...
    { id: 'h_hk', name: '하이니 (High Knee)', category: 'home', equipmentType: 'bodyweight', target: '하체+심폐', level: '중급', videoId: 'OAJ_J3EZkdY' },
    { id: 'h_js', name: '점핑잭', category: 'home', equipmentType: 'bodyweight', target: '전신+심폐', level: '초급', videoId: 'c4DAnQ6DtF8' },
  ...
  cardio: [
    ...
    { id: '13', name: '사이클', category: 'cardio', equipmentType: 'cardio', target: '하체, 심폐', level: '초급', videoId: '9L2b2khySLE' },
        { id: '14', name: '인클라인 트레드밀', category: 'cardio', equipmentType: 'cardio', target: '심폐+하체', level: '중급', videoId: '9L2b2khySLE' },
    { id: '15', name: '야외 러닝', category: 'cardio', equipmentType: 'cardio', target: '심폐지구력', level: '중급', videoId: '9L2b2khySLE' },
    { id: '16', name: '걷기', category: 'cardio', equipmentType: 'cardio', target: '심폐지구력', level: '초급', videoId: '9L2b2khySLE' },
    { id: '17', name: '줄넘기', category: 'cardio', equipmentType: 'cardio', target: '심폐+종아리', level: '초급', videoId: '9L2b2khySLE' },
    { id: '18', name: '스텝머신', category: 'cardio', equipmentType: 'cardio', target: '하체+심폐', level: '중급', videoId: '9L2b2khySLE' },
    { id: '19', name: '천국의 계단', category: 'cardio', equipmentType: 'cardio', target: '하체+심폐', level: '중급', videoId: '9L2b2khySLE' },
    { id: '20', name: '하이니 (High Knee)', category: 'cardio', equipmentType: 'cardio', target: '하체+심폐', level: '중급', videoId: '9L2b2khySLE' },
    { id: '21', name: '점핑잭', category: 'cardio', equipmentType: 'cardio', target: '전신+심폐', level: '초급', videoId: '9L2b2khySLE' },
